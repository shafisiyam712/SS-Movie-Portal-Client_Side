...
//       <h2 className="text-3xl font-extrabold text-center mb-10">Membership Plans</h2>
//       <div className="max-w-6xl mx-auto grid gap-6 grid-cols-1 md:grid-cols-3">
//         {plans.map((plan, index) => (
//           <div
//             key={index}
//             className="border rounded-xl shadow-md p-6 hover:shadow-lg transition duration-300"
//           >
//             <h3 className="text-2xl font-bold text-center mb-4">{plan.name}</h3>
//             <p className="text-center text-2xl text-[#1E2A47] font-semibold mb-6">{plan.price}</p>
...
//               <button className='btn font-bold border border-[#1E2A47] rounded-full text-[#1E2A47] w-1/2 hover:text-white hover:bg-[#1E2A47]'>Choose Plan</button>
//             </div>
//           </div>
//         ))}
//       </div>
      ...
      <div className="max-w-6xl mx-auto grid gap-6 grid-cols-1 md:grid-cols-3">
        {plans.map((plan, index) => (
          ...
          >
            ...
            <div className="text-center">
              <button className="btn font-bold border border-[#1E2A47] dark:border-white rounded-full text-[#1E2A47] dark:text-white w-1/2 hover:text-white hover:bg-[#1E2A47] dark:hover:bg-white dark:hover:text-[#1E2A47]">
                Choose Plan
              </button>
            </div>
          </div>
